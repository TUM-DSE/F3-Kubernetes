...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta3.FPGASchedulingArgs)(nil), (*config.FPGASchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_FPGASchedulingArgs_To_config_FPGASchedulingArgs(a.(*v1beta3.FPGASchedulingArgs), b.(*config.FPGASchedulingArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.FPGASchedulingArgs)(nil), (*v1beta3.FPGASchedulingArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_FPGASchedulingArgs_To_v1beta3_FPGASchedulingArgs(a.(*config.FPGASchedulingArgs), b.(*v1beta3.FPGASchedulingArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_FPGASchedulingArgs_To_config_FPGASchedulingArgs(in *v1beta3.FPGASchedulingArgs, out *config.FPGASchedulingArgs, s conversion.Scope) error {
	out.RecentUsageTimeWeight = in.RecentUsageTimeWeight
	out.RecentReconfigurationTimeWeight = in.RecentReconfigurationTimeWeight
	out.BitstreamLocalityWeight = in.BitstreamLocalityWeight
	return nil
}

// Convert_v1beta3_FPGASchedulingArgs_To_config_FPGASchedulingArgs is an autogenerated conversion function.
func Convert_v1beta3_FPGASchedulingArgs_To_config_FPGASchedulingArgs(in *v1beta3.FPGASchedulingArgs, out *config.FPGASchedulingArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_FPGASchedulingArgs_To_config_FPGASchedulingArgs(in, out, s)
}

func autoConvert_config_FPGASchedulingArgs_To_v1beta3_FPGASchedulingArgs(in *config.FPGASchedulingArgs, out *v1beta3.FPGASchedulingArgs, s conversion.Scope) error {
	out.RecentUsageTimeWeight = in.RecentUsageTimeWeight
	out.RecentReconfigurationTimeWeight = in.RecentReconfigurationTimeWeight
	out.BitstreamLocalityWeight = in.BitstreamLocalityWeight
	return nil
...
// Convert_config_FPGASchedulingArgs_To_v1beta3_FPGASchedulingArgs is an autogenerated conversion function.
func Convert_config_FPGASchedulingArgs_To_v1beta3_FPGASchedulingArgs(in *config.FPGASchedulingArgs, out *v1beta3.FPGASchedulingArgs, s conversion.Scope) error {
	return autoConvert_config_FPGASchedulingArgs_To_v1beta3_FPGASchedulingArgs(in, out, s)
}
